  ...
  return (
    <div className="p-6 space-y-6">
      <div className="space-y-1">
        <h2 className="text-2xl font-black text-cream dark:text-cream tracking-tight">Merchant Verification</h2>
        <p className="text-gray-teal dark:text-gray-teal text-xs font-bold uppercase tracking-widest">Review Shop Documents</p>
      </div>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-brand-slate dark:bg-brand-dark rounded-[32px] p-16 text-center space-y-4 border border-slate-100 dark:border-slate-800 shadow-sm">
            ...
            <div className="space-y-1">
              <h4 className="font-black uppercase tracking-tight text-sm text-cream dark:text-cream">No {activeTab} shops</h4>
              <p className="text-gray-teal dark:text-gray-teal text-[10px] font-medium">New shop submissions will appear here.</p>
            </div>
          </div>
        ) : (
          shops.map((shop) => (
            ...
            >
              ...
              <div className="w-16 h-16 rounded-[22px] bg-brand-slate dark:bg-brand-surface border border-slate-100 dark:border-slate-800 flex items-center justify-center overflow-hidden shadow-inner shrink-0 group-hover:scale-105 transition-transform">
                {shop.photoURL ? (
                  <img 
                    src={shop.photoURL} 
                  ...
                  <Store className="w-7 h-7 text-cream dark:text-slate-600" />
                )}
              </div>
              ...
              <div className="flex-1 min-w-0 space-y-1">
                ...
                <div className="flex items-center gap-1.5 pt-1.5 mt-1 border-t border-slate-50 dark:border-slate-800">
                  <MapPin className="w-3.5 h-3.5 text-cream dark:text-slate-600 shrink-0" />
                  <span className="text-[10px] font-medium text-gray-teal dark:text-gray-teal truncate italic">
              ...
              <div className="flex flex-col items-end gap-2">
                 <div className="flex items-center gap-1.5 opacity-60">
                    ...
                    <span className="text-[8px] font-black text-gray-teal dark:text-gray-teal uppercase tracking-widest whitespace-nowrap">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-cream dark:text-cream tracking-tight">{selectedShop.shopName}</h3>
                    <p className="text-[10px] font-bold text-gray-teal dark:text-gray-teal uppercase tracking-widest">{selectedShop.phone}</p>
                  </div>
                </div>
                <button onClick={() => setSelectedShop(null)} className="p-2 bg-slate-50 dark:bg-brand-surface rounded-xl"><X className="w-5 h-5 text-gray-teal dark:text-gray-teal" /></button>
              </div>

              <div className="space-y-6">
                <div className="space-y-2">
                  <h4 className="text-[10px] font-black text-gray-teal dark:text-gray-teal uppercase tracking-widest px-2">Business Proof</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <p className="text-[8px] font-black text-gray-teal dark:text-gray-teal uppercase tracking-widest text-center">Trade License</p>
                    ...
                    <div className="space-y-2">
                      <p className="text-[8px] font-black text-gray-teal dark:text-gray-teal uppercase tracking-widest text-center">Shop Front</p>
                      <div className="h-32 bg-slate-50 dark:bg-brand-surface rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800">
                        <img 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 dark:bg-brand-surface rounded-2xl p-4 space-y-1">
                    ...
                    <p className="text-xs font-black text-cream dark:text-cream truncate">
                ...
                <div className="bg-slate-50 dark:bg-brand-surface rounded-2xl p-4 space-y-1">
                  ...
                  <p className="text-xs font-medium text-slate-600 dark:text-cream">
