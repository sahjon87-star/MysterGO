    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      <div className="bg-slate-900 px-4 pt-10 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between mb-8">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-black text-white uppercase tracking-tight">Help Center</h1>
            <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Support Hub</p>
          </div>
          <div className="w-10" />
        </div>
        ...
        <div className="relative z-10 w-full">
           <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white/10 backdrop-blur-md border border-white/20 rounded-[28px] pl-16 pr-6 py-6 text-white placeholder-slate-400 outline-none focus:ring-2 focus:ring-primary-blue transition-all shadow-xl"
              />
           </div>
        </div>
      </div>
      ...
      <div className="w-full px-4 -mt-8 relative z-20 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
           <button className="bg-white dark:bg-slate-900 p-6 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl flex flex-col items-center gap-3 text-center group active:scale-95 transition-all">
              ...
              <span className="text-[10px] font-black uppercase text-slate-700 dark:text-slate-300 tracking-widest">Live Chat</span>
           </button>
           <button 
             onClick={() => window.open('tel:01700000000')}
             className="bg-white dark:bg-slate-900 p-6 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl flex flex-col items-center gap-3 text-center group active:scale-95 transition-all"
           >
              ...
              <span className="text-[10px] font-black uppercase text-slate-700 dark:text-slate-300 tracking-widest">Call Center</span>
           </button>
        </div>

        {/* Categories */}
        <div className="space-y-4">
          <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] px-4">Topics</h3>
          <div className="bg-white dark:bg-slate-900 rounded-[40px] border border-slate-50 dark:border-slate-800 overflow-hidden shadow-sm">
            {[
              ...
              { label: 'Account Settings', icon: AlertCircle, color: 'text-slate-400' }
            ].map((topic, i) => (
              <button key={i} className="w-full flex items-center justify-between p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors border-b last:border-0 border-slate-50 dark:border-slate-800">
                <div className="flex items-center gap-4">
                  <topic.icon className={`w-5 h-5 ${topic.color}`} />
                  <span className="text-sm font-bold text-slate-700 dark:text-slate-300">{topic.label}</span>
                </div>
        ...
        <div className="space-y-4 pb-20">
          <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] px-4">Common Questions</h3>
          <div className="space-y-3">
             {faqs.map((f, i) => (
               <details key={i} className="group bg-white dark:bg-slate-900 rounded-[28px] border border-slate-100 dark:border-slate-800 overflow-hidden">
                  <summary className="list-none p-6 flex items-center justify-between cursor-pointer">
                    <h4 className="text-sm font-bold text-slate-800 dark:text-white pr-6 leading-tight">{f.q}</h4>
