      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl font-black text-slate-950 dark:text-white tracking-tighter uppercase">User Agreement</h1>
            <p className="text-slate-400 dark:text-slate-500 font-bold uppercase text-[10px] tracking-[0.3em]">Complete Bangladesh Compliant Version • Last Updated June 2026</p>
          </div>
        </div>
