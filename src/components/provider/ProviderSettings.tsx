        ...
        {activeTab === 'main' && (
          ...
          >
            <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-50 dark:border-slate-800 overflow-hidden shadow-sm">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <p className="text-sm font-bold text-slate-700 dark:text-slate-300">Account Information</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Profile, Services, Experience</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <p className="text-sm font-bold text-slate-700 dark:text-slate-300">Display & Appearance</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Dark Mode, Language</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-300" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <p className="text-sm font-bold text-slate-700 dark:text-slate-300">Privacy & Security</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Permissions, Online Status</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-300" />
              </button>
              ...
              <button className="w-full flex items-center justify-between p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Push settings, SMS</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-300" />
              </button>
            ...
            <div className="space-y-4">
              <h3 className="text-[10px] font-black text-slate-300 dark:text-slate-600 uppercase tracking-[0.3em] px-4">Support & About</h3>
               <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-50 dark:border-slate-800 overflow-hidden shadow-sm">
                  <button className="w-full flex items-center justify-between p-6 border-b border-slate-50 dark:border-slate-800">
                    ...
                    <span className="text-xs font-black text-slate-300">2.1.0-gold</span>
                  </button>
                  <button className="w-full flex items-center justify-between p-6">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Check for Updates</span>
                    </div>
                    <ChevronRight className="w-5 h-5 text-slate-300" />
                  </button>
               </div>
        ...
        {activeTab === 'account' && (
          ...
          >
            <div className="space-y-6">
               ...
               <div className="space-y-2">
                 <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-4">Primary Service</label>
                 <select 
               ...
               <div className="space-y-2">
                 <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-4">Experience (Years)</label>
                 <input 
                   type="number" 
             ...
             <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-50 dark:border-slate-800 space-y-8">
               <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] font-medium text-slate-400 mt-0.5">Adjust app brightness</p>
                  </div>
                  <ThemeToggle />
               </div>

               <div className="space-y-4 pt-8 border-t border-slate-50 dark:border-slate-800">
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Preferred Language</h4>
                  <div className="grid grid-cols-2 gap-3">
                     {languages.map((l) => (
                       <button
                         key={l.code}
                         onClick={() => setLang(l.code)}
                         className={`py-6 rounded-[24px] flex flex-col items-center gap-2 border-2 transition-all ${lang === l.code ? 'bg-primary-blue border-primary-blue text-white shadow-xl shadow-primary-blue/20' : 'bg-slate-50 dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-500'}`}
                       >
        ...
        {activeTab === 'privacy' && (
          ...
          >
             <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-50 dark:border-slate-800 space-y-8">
               <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-tight">Online Status</h4>
                    <p className="text-[10px] font-medium text-slate-400 mt-0.5">Show as available on map</p>
                  </div>
                  <div className={`w-12 h-6 rounded-full relative p-1 transition-all ${profile?.isOnline ? 'bg-primary-blue' : 'bg-slate-200 dark:bg-slate-800'}`}>
                    <div className={`w-4 h-4 rounded-full bg-white transition-all ${profile?.isOnline ? 'translate-x-6' : 'translate-x-0'}`} />
                  </div>
               </div>
               ...
               <div className="space-y-4 pt-8 border-t border-slate-50 dark:border-slate-800">
                  <button className="w-full flex items-center justify-between group">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Change Password</span>
                    </div>
                    <ChevronRight className="w-5 h-5 text-slate-300" />
                  </button>
                  <button className="w-full flex items-center justify-between group pt-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Blocked Customers</span>
                    </div>
                    <ChevronRight className="w-5 h-5 text-slate-300" />
                  </button>
               </div>
